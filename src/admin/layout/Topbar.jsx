import { Bell, LogOut, Menu, Moon, Sun, Key, Eye, EyeOff, CheckCheck } from 'lucide-react'
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {unreadCount > 0 && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-amber-600 hover:bg-amber-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {markingAllAsRead ? (
                            <>
