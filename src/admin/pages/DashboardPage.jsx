...
//     })
//     return [
//       { name: 'Unpaid', value: stages.unpaid, color: '#ef4444' },
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-3 lg:grid-cols-3">
        ...
        <Card accent="amber" className="p-0" kpi>
          <div className="relative p-3">
            ...
            <div className={cardValueClass}>{pdiLoading ? '—' : advancePaidCount}</div>
              ...
              <PieChart>
                ...
                >
                  {vehicleTypesData.map((entry, index) => (
                    <Cell key={`cell-${index}`} fill={index === 0 ? '#22d3ee' : '#10b981'} />
                  ))}
                </Pie>
                <Legend wrapperStyle={{ fontSize: 12 }} />
              </PieChart>
              ...
              <PieChart>
                ...
                >
                  {vehicleBrandsData.map((entry, index) => (
                    <Cell key={`cell-${index}`} fill={['#22d3ee', '#a78bfa', '#f59e0b', '#10b981', '#ef4444', '#8b5cf6'][index % 6]} />
                  ))}
                </Pie>
                <Legend wrapperStyle={{ fontSize: 12 }} />
              </PieChart>
