      ...
      <ReasonDialog
        ...
        description={
          selectedSlot?.is_available
            ? `Disable slot from ${selectedSlot ? selectedSlot.start : ''} to ${selectedSlot ? selectedSlot.end : ''} on ${formatDate(selectedDate)}`
            : `Enable slot from ${selectedSlot ? selectedSlot.start : ''} to ${selectedSlot ? selectedSlot.end : ''} on ${formatDate(selectedDate)}`
        }
